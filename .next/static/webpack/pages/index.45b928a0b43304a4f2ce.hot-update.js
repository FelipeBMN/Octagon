...
function Home() {
  ...
  var _useState = Object(react__WEBPACK_IMPORTED_MODULE_1__["useState"])(''),
      headerClassName = _useState[0],
      setHeaderClassName = _useState[1];

  var handleScroll = function handleScroll(headerClassName) {
  ...
  react__WEBPACK_IMPORTED_MODULE_1___default.a.useEffect(function () {
    window.onscroll = function () {
      return handleScroll(headerClassName);
    };
...
_s(Home, "NbUvQZb+0nwIvW+XBnM5m9RMkWM=");
...
function MyApp() {
  ...
  if (offset > 100) {
    jquery__WEBPACK_IMPORTED_MODULE_4___default()('header').addClass('menu');
  }

  console.log(offset);
}

_s2(MyApp, "WzXr9uhGfXxPyY3YDt08E2OJQzY=");

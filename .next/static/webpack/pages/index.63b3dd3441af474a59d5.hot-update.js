  ...
  document.addEventListener("DOMContentLoaded", function () {
    window.onscroll = function () {
      ...
      if (window.pageYOffset > 100) {
        jquery__WEBPACK_IMPORTED_MODULE_2___default()('header').addClass('menu');
      } else {
        jquery__WEBPACK_IMPORTED_MODULE_2___default()('header').removeClass('menu');
      }
    };
  });
